## 2026.6.0-inokashiraskey.1
## 2026.6.0-kinel.1 (merged to 2026.6.0-inokashiraskey.1)
## 2026.6.0 (merged to 2026.6.0-kinel.1)
...
### Note
- 2026.5.4-kinel.3のリリース処理を間違えてしまったため、2026.5.4-kinel.4として再度リリースしました。
...
## 2026.3.2-inokashiraskey.1
## 2026.3.2-kinel.1 (merged to 2026.3.2-inokashiraskey.1)

## 2026.3.2 (merged to 2026.3.2-kinel.1)
...
## 2026.3.1 (merged to 2026.3.1-kinel.1)
...
## 2025.12.2-inokashiraskey.4
## 2025.12.2-kinel.4 (merged to 2025.12.2-inokashiraskey.4)

### Frontend
- Fix: 削除されたノートのリノートの表示が正しくない問題

## 2025.12.2-kinel.3

### General
- 削除されたノートの維持の動作を改善しました。
  - 純粋な renote については維持しないようにしました。	
    - 純粋な renote については renoteId を維持してしまうと実質的に何も削除していないのに似た状態になるため維持しないことにしました。
  - 削除されたノートのユーザ情報を残さないようにしました。
    - 私が覚えてる Twitter の動作に揃えました。
  - ユーザ削除時に同様にミニマムの情報を維持するようにしました。
    - これによりCASCADEでNoteが勝手に消える事例が多分なくなりました。
  - フロントエンドの描画をより良くしました。
  - 削除されたノートの描画を存在するノートに寄せることによって、リプライ関係であることがわかりやすくなりました。
  - 過去のバージョンのCASCADE削除によって消えたノートと情報が残ってるノートの描画が似たものになるようにしました

## 2025.12.2-kinel.2

### Server
- Fix: 特定の条件下でノートの取得に失敗する問題を修正

## 2025.12.2-kinel.1


### Client
- ユーザーページにて、センシティブチャンネルのノートが表示されない問題を修正
- 削除されたノートのリノートにおいて、`(削除されたノート)`等ではなく`Deleted note`と表示される問題を修正
- 削除されたノートに、常にクリップボタン(または操作不可表示のボタン)が余分に表示される問題を修正

## 2025.12.2 (merged to 2025.12.2-kinel.1)
...
## 2025.12.1 (merged to 2025.12.2-kinel.1)
...
## 2025.12.0 (merged to 2025.12.2-kinel.1)
## 2025.12.0-kinel.1
...
## 2025.10.2-inokashiraskey.1
## 2025.10.2-kinel.1 (merged to 2025.10.2-inokashiraskey.1)
...
## 2025.10.1-kinel.1
## 2025.10.1 (merged to 2025.10.1-kinel.1)
...
## 2025.10.0-kinel.1
## 2025.10.0 (merged to 2025.10.0-kinel.1)
...
## 2025.9.0-kinel.1
## 2025.9.0 (merged to 2025.9.0-kinel.1)
...
### General
- 削除されたノートのリプライ関係が維持されるようになりました
  - APIで、deletedAtフィールドが使用されるようになりました。型定義への変更はありません。

## 2025.8.0-kinel.1

## 2025.8.0 (merged to 2025.8.0-kinel.1)
