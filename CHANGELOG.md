## 2025.7.0-inokashiraskey.1

## 2025.7.0-kinel.1 (merged to 2025.7.0-inokashiraskey.1)

### Client
- Fix: C++ のシンタックスハイライトが Safari でフリーズする問題を修正
- Enhance: 「自動でもっと見る」オプションを再度有効に

## 2025.7.0 (merged to 2025.7.0-kinel.1)
...
## 2025.6.3 (merged to 2025.6.3-kinel.1)
...
## 2025.4.0-inokashiraskey.1

## 2025.4.0-kinel.1 (merged to 2025.4.0-inokashiraskey.1)

### Client
- Enhance: ファイルのアップロードでデフォルトで圧縮するかどうかのオプションが復活しました。
  - 画像データの貼り付け、ドロップ時も今まで通りデフォルトで圧縮するかのオプションに基づきます

## Server
- 通報をDiscordのWebhookに送信できる機能を削除
  - SystemWebhookに置き換えられました

## 2025.4.0 (merged to 2025.4.0-kinel.1)
...
## 2025.3.1-inokashiraskey.1
## 2025.3.1 (merged to 2025.4.0-kinel.1)
...
## 2025.3.0 (merged to 2025.4.0-kinel.1)
...
なお、URLとURIが異なるエンティティの照会に失敗する問題を修正( #15039 )に関しては 2025.1.0 準拠に変更しました。
...
### 全体的に
2024.10.0-kinel.2までの変更を取り込みました。

### Server
- Enhance: robots.txtで生成AIクローラーを弾くように設定しました。
